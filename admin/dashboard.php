...
<body>
    ...
    <div style="max-width:900px; margin:40px auto; padding:0 20px;">
        ...
        <h1 style="font-size:26px; color:#333; margin-bottom:30px; text-align:center;">
            Admin Dashboard
        </h1>
        ...
        <div style="display:flex; flex-direction:column; gap:14px;">
            ...
            <div style="display:flex; flex-wrap:wrap; justify-content:center; gap:14px;">
                ...
                <a href="addStudent.php"
                    style="flex: 0 1 calc(33.33% - 14px); min-width:200px; background:white; border:1px solid #dbdbdb; border-radius:10px; padding:20px; text-align:center; text-decoration:none; color:#333; font-size:15px; font-weight:bold; box-shadow:0 1px 4px rgba(0,0,0,0.05);"
            ...
            <div style="display:flex; justify-content:center;">
                ...
                <a href="assignInternship.php"
                    style="flex:1; max-width:100%; background:white; border:1px solid #dbdbdb; border-radius:10px; padding:20px; text-align:center; text-decoration:none; color:#333; font-size:15px; font-weight:bold; box-shadow:0 1px 4px rgba(0,0,0,0.05);"
                    onmouseover="this.style.background='#0095f6'; this.style.color='white';"
                    onmouseout="this.style.background='white'; this.style.color='#333';">
                    <span style="font-size:28px; display:block; margin-bottom:10px;">📋</span>
                    Assign Internship
